...
public class LinkQuizManager : MonoBehaviour 
{
    ...
    Geography_Quiz_Script1 society_Qui2;
            ...
            if (stage == society_Qui2.LinkQuizDict[i].stage)
            {
                if (id == society_Qui2.LinkQuizDict[i].id)
                {
                    ...
                    if (society_Qui2.LinkQuizDict[i].Answer[0] != "*")
                    {
                        ...
                        _qPrefab.transform.GetChild(1).GetChild(0).GetComponent<Text>().text = i.ToString();
						//_qPrefab.transform.GetChild(0).GetChild(0).GetComponent<Text>().text = society_Qui2.LinkQuizDict[i].left[0];
                        _qPrefab.transform.SetParent(quizParent, false);

                        GameObject _aPrefab = Instantiate(aPanelPrefab);
                        _aPrefab.transform.GetChild(1).GetChild(0).GetComponent<Text>().text = society_Qui2.LinkQuizDict[i].Order[0];
						//_aPrefab.transform.GetChild(0).GetChild(0).GetComponent<Text>().text = society_Qui2.LinkQuizDict[i].right[0];
            ...
            if (stage == society_Qui2.ImgLinkQuizDict[i].stage)
            {
                if (id == society_Qui2.ImgLinkQuizDict[i].id)
                {
                    ...
                    if (society_Qui2.ImgLinkQuizDict[i].Answer[0] != "*")
                    {
						...
						//_qPrefab.transform.GetChild(0).GetChild(0).GetComponent<Image>().sprite = Resources.Load<Sprite>(society_Qui2.ImgLinkQuizDict[i].left[0]);
                        ...
                        //_aPrefab.transform.GetChild(0).GetChild(0).GetComponent<Image>().sprite = Resources.Load<Sprite>(society_Qui2.ImgLinkQuizDict[i].right[0]);
                        _aPrefab.transform.GetChild(1).GetChild(0).GetComponent<Image>().sprite = Resources.Load<Sprite>(society_Qui2.ImgLinkQuizDict[i].Order[0]);
